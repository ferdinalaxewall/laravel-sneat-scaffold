!function(t, o) {
    if ("object" == typeof exports && "object" == typeof module)
        ...
        var e = o();
        for (var d in e)
            ("object" == typeof exports ? exports : t)[d] = e[d]
    }
}(self, (function() {
    return function(t) {
        if (t && t.fn) {
            ...
            t((function() {
                t("body").on("mouseenter", "".concat(o, ", ").concat(o, " ~ .dropdown-menu"), (function() {
                    ...
                    "static" !== window.getComputedStyle(n[0], null).getPropertyValue("position") && (t(this).is(o) && t(this).data("hovered", !0),
                    (d = (e = t(this).hasClass("dropdown-toggle") ? t(this) : t(this).prev(".dropdown-toggle")).data("dd-timeout")) && (clearTimeout(d),
                    d = null,
                    e.data("dd-timeout", d)),
                    ...
                    t(this).hasClass("dropdown-toggle") ? t(this) : t(this).prev(".dropdown-toggle");
                    var e, d, n = t(this).hasClass("dropdown-menu") ? t(this) : t(this).next(".dropdown-menu");
                    "static" !== window.getComputedStyle(n[0], null).getPropertyValue("position") && (t(this).is(o) && t(this).data("hovered", !1),
                    (d = (e = t(this).hasClass("dropdown-toggle") ? t(this) : t(this).prev(".dropdown-toggle")).data("dd-timeout")) && clearTimeout(d),
