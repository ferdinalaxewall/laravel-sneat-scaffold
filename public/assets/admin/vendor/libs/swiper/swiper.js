!function(e, t) {
    ...
    return function() {
            ...
            for (let a = 1; a < arguments.length; a += 1) {
                ...
                !("undefined" != typeof window && void 0 !== window.HTMLElement ? s instanceof HTMLElement : s && (1 === s.nodeType || 11 === s.nodeType)))) {
                    ...
                    for (let t = 0, a = s.length; t < a; t += 1) {
                        ...
                        void 0 !== r && r.enumerable && (u(e[a]) && u(i[a]) ? i[a].__swiper__ ? e[a] = i[a] : m(e[a], i[a]) : !u(e[a]) && u(i[a]) ? (e[a] = {},
                        i[a].__swiper__ ? e[a] = i[a] : m(e[a], i[a])) : e[a] = i[a])
                    }
                }
            }
            var s;
        ...
        function b(e, t) {
            ...
            return s.classList.add(...Array.isArray(t) ? t : o(t)),
            s
        }
        function y(e) {
            const t = l()
        ...
        var G = {
            updateSize: function() {
                ...
                0 === t && e.isHorizontal() || 0 === s && e.isVertical() || (t = t - parseInt(E(a, "padding-left") || 0, 10) - parseInt(E(a, "padding-right") || 0, 10),
            ...
            updateSlides: function() {
                ...
                s.centeredSlides && s.cssMode && (h(a, "--swiper-centered-offset-before", ""),
                ...
                for (let a = 0; a < p; a += 1) {
                    ...
                    !c[a] || "none" !== E(i, "display")) {
                        ...
                        f.push(L),
                        s.centeredSlides ? (S = S + L / 2 + T / 2 + x,
                        0 === T && 0 !== a && (S = S - r / 2 - x),
                        0 === a && (S = S - r / 2 - x),
                        Math.abs(S) < .001 && (S = 0),
                        ...
                        (C - Math.min(e.params.slidesPerGroupSkip, C)) % e.params.slidesPerGroup == 0 && u.push(S),
                        m.push(S),
                        S = S + L + x),
                        e.virtualSize += L + x,
                        T = L,
                ...
                s.centeredSlides && s.cssMode && !s.centeredSlidesBounds) {
                    ...
                    h(a, "--swiper-centered-offset-after", e.size / 2 - f[f.length - 1] / 2 + "px");
        ...
        var H = {
            slideTo: function(e, t, s, a, i) {
                ...
                let n = e;
                n < 0 && (n = 0);
                const {params: l, snapGrid: o, slidesGrid: d, previousIndex: c, activeIndex: p, rtlTranslate: u, wrapperEl: m, enabled: h} = r;
                if (r.animating && l.preventInteractionOnTransition || !h && !a && !i || r.destroyed)
                    return !1;
            ...
            slideToClickedSlide: function() {
                ...
                if (t.loop) {
                    ...
                    r = e.getSlideIndex(v(s, `${n}[data-swiper-slide-index="${i}"]`)[0]),
                    d((()=>{
                        e.slideTo(r)
                    }
          ...
          , X = {
            loopCreate: function(e) {
                ...
                t.recalcSlides(),
                t.updateSlides()) : w("Swiper Loop Warning: The number of slides is not even to slidesPerGroup, loop mode may not function properly. You need to add more slides (or make duplicates, or empty slides)"),
                i()) : o ? (s.loopAddBlankSlides ? (d(s.grid.rows - t.slides.length % s.grid.rows),
                t.recalcSlides(),
                t.updateSlides()) : w("Swiper Loop Warning: The number of slides is not even to grid.rows, loop mode may not function properly. You need to add more slides (or make duplicates, or empty slides)"),
                i()) : i(),
                t.loopFix({
                    slideRealIndex: e,
            ...
            loopFix: function(e) {
                ...
                d.length < f + v ? w("Swiper Loop Warning: The number of slides is not enough for loop mode, it will be disabled and not function properly. You need to add more slides (or make duplicates) or lower the values of slidesPerView and slidesPerGroup parameters") : b && "row" === m.grid.fill && w("Swiper Loop Warning: Loop mode is not compatible with grid.fill = `row`");
                const y = []
                  , E = [];
                let x = o.activeIndex;
        ...
        function Y(e, t, s) {
            ...
            return !r || !(s <= n || s >= a.innerWidth - n) || "prevent" === r && (t.preventDefault(),
            !0)
        }
        function B(e) {
            const t = this
            ...
            if ("pointerdown" === a.type) {
                if (null !== i.pointerId && i.pointerId !== a.pointerId)
                    return;
                i.pointerId = a.pointerId
            } else
                "touchstart" === a.type && 1 === a.targetTouches.length && (i.touchId = a.targetTouches[0].identifier);
            if ("touchstart" === a.type)
                return void Y(t, a, a.targetTouches[0].pageX);
            const {params: n, touches: o, enabled: d} = t;
            if (!d)
                return;
            if (!n.simulateTouch && "mouse" === a.pointerType)
                return;
            ...
            let w = !0;
            p.matches(i.focusableElements) && (w = !1,
            ...
            !n.touchStartForcePreventDefault && !b || p.isContentEditable || a.preventDefault(),
        ...
        function R(e) {
            ...
            "pointermove" === p.type) {
                if (null !== a.touchId)
                    return;
                if (p.pointerId !== a.pointerId)
                    return
            }
            if ("touchmove" === p.type) {
                if (d = [...p.changedTouches].filter((e=>e.identifier === a.touchId))[0],
            ...
            if (p.preventedByNestedSwiper)
                ...
                void (n.startY = m);
            if (!s.allowTouchMove)
                return p.target.matches(a.focusableElements) || (s.allowClick = !1),
            ...
            if (i.touchReleaseOnEdges && !i.loop)
                if (s.isVertical()) {
                    ...
                    return;
            if (t.activeElement && p.target === t.activeElement && p.target.matches(a.focusableElements))
                return a.isMoved = !0,
                void (s.allowClick = !1);
            ...
            i.oneWayMovement && (g = Math.abs(g) * (l ? 1 : -1),
            v = Math.abs(v) * (l ? 1 : -1)),
            n.diff = g,
            g *= i.touchRatio,
            l && (g = -g,
            ...
            g > 0 ? (b && y && a.allowThresholdMove && a.currentTranslate > (i.centeredSlides ? s.minTranslate() - s.slidesSizesGrid[s.activeIndex + 1] : s.minTranslate()) && s.loopFix({
                direction: "prev",
                setTranslate: !0,
                activeSlideIndex: 0
            }),
            a.currentTranslate > s.minTranslate() && (E = !1,
            i.resistance && (a.currentTranslate = s.minTranslate() - 1 + (-s.minTranslate() + a.startTranslate + g) ** x))) : g < 0 && (b && y && a.allowThresholdMove && a.currentTranslate < (i.centeredSlides ? s.maxTranslate() + s.slidesSizesGrid[s.slidesSizesGrid.length - 1] : s.maxTranslate()) && s.loopFix({
                direction: "next",
                setTranslate: !0,
            ...
            i.resistance && (a.currentTranslate = s.maxTranslate() + 1 - (s.maxTranslate() - a.startTranslate - g) ** x))),
        ...
        function F(e) {
            ...
            s.pointerId = null,
            s.touchId = null;
            const {params: r, touches: n, rtlTranslate: l, slidesGrid: o, enabled: p} = t;
            if (!p)
                return;
            ...
            s.isMoved = !1,
            s.startMoving = !1,
            h = r.followFinger ? l ? t.translate : -t.translate : -s.currentTranslate,
            r.cssMode)
                return;
            ...
            for (let e = 0; e < o.length; e += e < r.slidesPerGroupSkip ? 1 : r.slidesPerGroup) {
                ...
                void 0 !== o[e + t] ? (f || h >= o[e] && h < o[e + t]) && (g = e,
                v = o[e + t] - o[e]) : (f || h >= o[e]) && (g = e,
        ...
        const U = (e,t)=>{
            ...
            a.updateOnWindowResize ? e[c](l.ios || l.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", q, !0) : e[c]("observerUpdate", q, !0),
            i[d]("load", e.onLoad, {
                capture: !0
            })
        }
        ...
        class te {
            ...
            mount(e) {
                ...
                let i = s && s.shadowRoot && s.shadowRoot.querySelector ? s.shadowRoot.querySelector(a()) : v(s, a())[0];
                return !i && t.params.createElements && (i = b("div", t.params.wrapperClass),
                s.append(i),
        ...
        const me = [function(e) {
            let t, {swiper: s, extendParams: a, on: i, emit: n} = e;
            a({
                virtual: {
                    enabled: !1,
                    slides: [],
            ...
            function d(e, t) {
                ...
                i = o.children[0])) : i = s.isElement ? b("swiper-slide") : b("div", s.params.slideClass),
        ...
        , function(e) {
            ...
            function d(e) {
                ...
                if (!(a.shiftKey || a.altKey || a.ctrlKey || a.metaKey || n.activeElement && n.activeElement.nodeName && ("input" === n.activeElement.nodeName.toLowerCase() || "textarea" === n.activeElement.nodeName.toLowerCase()))) {
                    if (t.params.keyboard.onlyInViewport && (d || c || p || u || m || h)) {
                        let e = !1;
                        if (S(t.el, `.${t.params.slideClass}, swiper-slide`).length > 0 && 0 === S(t.el, `.${t.params.slideActiveClass}`).length)
                            return;
                        const a = t.el
                          , i = a.clientWidth
                          , r = a.clientHeight
            ...
            function c() {
                t.keyboard.enabled || (n.addEventListener("keydown", d),
                t.keyboard.enabled = !0)
            }
            function p() {
                t.keyboard.enabled && (n.removeEventListener("keydown", d),
        ...
        , function(e) {
            ...
            function f(e) {
                return !(t.params.mousewheel.thresholdDelta && e.delta < t.params.mousewheel.thresholdDelta || t.params.mousewheel.thresholdTime && c() - p < t.params.mousewheel.thresholdTime || !(e.delta >= 6 && c() - p < 60) && (e.direction < 0 ? t.isEnd && !t.params.loop || t.animating || (t.slideNext(),
        ...
        , function(e) {
            ...
            function p() {
                ...
                "bullets" === s.type && t.pagination.bullets && t.pagination.bullets.length > 0) {
                    ...
                    let o, p, u;
                    if (s.dynamicBullets && (n = M(i[0], t.isHorizontal() ? "width" : "height", !0),
                    c.forEach((e=>{
            ...
            function m() {
                ...
                s.length > 1 && (s = s.filter((e=>S(e, ".swiper")[0] === t.el))[0])),
        ...
        , function(e) {
            ...
            function E(e) {
                const {scrollbar: s, rtlTranslate: a} = t
                  , {el: i} = s;
                let r;
                r = (w(e) - y(i)[t.isHorizontal() ? "left" : "top"] - (null !== l ? l : c / 2)) / (p - c),
            ...
            function x(e) {
                const s = t.params.scrollbar
                  ...
                  , {el: n, dragEl: o} = a;
                m = !0,
                l = e.target === o ? w(e) - e.target.getBoundingClientRect()[t.isHorizontal() ? "left" : "top"] : null,
                e.preventDefault(),
                e.stopPropagation(),
            ...
            function P() {
                ...
                i || "string" != typeof a.el)
                    i || (i = a.el);
                else if (i = n.querySelectorAll(a.el),
                !i.length)
                    return;
                ...
                r || (r = b("div", t.params.scrollbar.dragClass),
                i.append(r))),
                Object.assign(e, {
                    el: i,
                    dragEl: r
                ...
                i && i.classList[t.enabled ? "remove" : "add"](...o(t.params.scrollbar.lockClass))
            }
            function L() {
                const e = t.params.scrollbar
                  , s = t.scrollbar.el;
                s && s.classList.remove(...o(t.isHorizontal() ? e.horizontalClass : e.verticalClass)),
        ...
        , function(e) {
            ...
            function E(e) {
                ...
                !(u.length < 2)) {
                    ...
                    !m.slideEl) {
                        ...
                        m.imageEl = a,
                        m.imageWrapEl = a ? S(m.imageEl, `.${s.containerClass}`)[0] : void 0,
                        !m.imageWrapEl)
            ...
            function x(e) {
                ...
                u.length < 2 || (o = !0,
                m.scaleMove = w(),
                m.imageEl && (a.scale = m.scaleMove / m.scaleStart * d,
            ...
            function M(e) {
                ...
                if (a < m.slideWidth && i < m.slideHeight)
                    return;
                if (h.minX = Math.min(m.slideWidth / 2 - a / 2, 0),
                h.maxX = -h.minX,
            ...
            function P(e) {
                ...
                if (!m.slideEl) {
                    ...
                    m.slideEl || (t.params.virtual && t.params.virtual.enabled && t.virtual ? m.slideEl = v(t.slidesEl, `.${t.params.slideActiveClass}`)[0] : m.slideEl = t.slides[t.activeIndex]);
                    let s = m.slideEl.querySelector(`.${a.containerClass}`);
                    s && (s = s.querySelectorAll("picture, img, svg, canvas, .swiper-zoom-target")[0]),
                    m.imageEl = s,
                    m.imageWrapEl = s ? S(m.imageEl, `.${a.containerClass}`)[0] : void 0
                }
                if (!m.imageEl || !m.imageWrapEl)
                    return;
                let i, n, l, o, c, p, u, f, g, w, b, E, x, T, M, C, P, L;
                t.params.cssMode && (t.wrapperEl.style.overflow = "hidden",
                t.wrapperEl.style.touchAction = "none"),
                m.slideEl.classList.add(`${a.zoomedSlideClass}`),
                void 0 === h.touchesStart.x && e ? (i = e.pageX,
                n = e.pageY) : (i = h.touchesStart.x,
                n = h.touchesStart.y);
                const I = "number" == typeof e ? e : null;
                1 === d && I && (i = void 0,
                n = void 0),
                s.scale = I || m.imageWrapEl.getAttribute("data-swiper-zoom") || a.maxRatio,
                d = I || m.imageWrapEl.getAttribute("data-swiper-zoom") || a.maxRatio,
                !e || 1 === d && I ? (u = 0,
                f = 0) : (P = m.slideEl.offsetWidth,
            ...
            function L() {
                ...
                if (!m.slideEl) {
                    ...
                    m.imageEl = e,
                    m.imageWrapEl = e ? S(m.imageEl, `.${s.containerClass}`)[0] : void 0
                }
            ...
            a("paginationUpdate", (()=>{
                t.params.a11y.enabled && function() {
                    ...
                    h() && t.pagination.bullets.forEach((s=>{
                        ...
                        c(s, e.paginationBulletMessage.replace(/\{\{index\}\}/, x(s) + 1)))),
        ...
        , function(e) {
            let t, s, {swiper: a, extendParams: i, on: n, emit: l, params: o} = e;
            a.autoplay = {
                running: !1,
                paused: !1,
                timeLeft: 0
            ...
            n("sliderFirstMove", (()=>{
                !a.destroyed && a.autoplay.running && (a.params.autoplay.disableOnInteraction ? T() : (p = !0,
                u = !1,
                f = !1,
                m = setTimeout((()=>{
                    f = !0,
        ...
        , function(e) {
            ...
            function d(e) {
                ...
                s.params.loop || s.params.virtual && s.params.virtual.enabled)
                    for (let e = 0; e < i; e += 1)
                        v(s.slidesEl, `[data-swiper-slide-index="${t.realIndex + e}"]`).forEach((e=>{
                            e.classList.add(r)
                        }
                        ));
                else
                        ...
                        if (s < -t.minTranslate())
                            ...
                            if (r.freeMode.momentum) {
                                ...
                                if (p < t.maxTranslate())
                                    ...
                                    u = t.maxTranslate(),
                                    m = !0,
                                    d.allowMomentumBounce = !0) : p = t.maxTranslate(),
                                    r.loop && r.centeredSlides && (f = !0);
                                else if (p > t.minTranslate())
                                    r.freeMode.momentumBounce ? (p - t.minTranslate() > h && (p = t.minTranslate() + h),
                                    u = t.minTranslate(),
                                    m = !0,
                                    d.allowMomentumBounce = !0) : p = t.minTranslate(),
                                    r.loop && r.centeredSlides && (f = !0);
                                    ...
                                    p = Math.abs(o[e] - p) < Math.abs(o[e - 1] - p) || "next" === t.swipeDirection ? o[e] : o[e - 1],
                                    p = -p
                                }
        ...
        , function(e) {
            ...
            const i = (e,t,s)=>{
                ...
                a || (a = b("div", ("swiper-slide-shadow-cube swiper-slide-shadow-" + (s ? "left" : "top")).split(" ")),
                e.append(a)),
                i || (i = b("div", ("swiper-slide-shadow-cube swiper-slide-shadow-" + (s ? "right" : "bottom")).split(" ")),
                e.append(i)),
