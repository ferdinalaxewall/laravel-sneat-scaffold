                    ...
                    function I(p, v) {
                        ...
                        function F() {
                            ...
                            !1 === e.weekNumbers && 1 === e.showMonths || !0 !== e.noCalendar && window.requestAnimationFrame((function() {
                                if (void 0 !== b.calendarContainer && (b.calendarContainer.style.visibility = "hidden",
                                ...
                                void 0 !== b.daysContainer) {
                                    ...
                                    b.calendarContainer.style.width = t + (void 0 !== b.weekWrapper ? b.weekWrapper.offsetWidth : 0) + "px",
                        ...
                        function A(e) {
                            ...
                            void 0 !== e && "blur" !== e.type && function(e) {
                                ...
                                if (void 0 !== a.value && 2 === a.value.length) {
                                    var u = a === b.hourElement
                                      , f = a === b.minuteElement;
                                    d < i ? (d = l + d + r(!u) + (r(u) && r(!b.amPM)),
                                    f && B(void 0, -1, b.hourElement)) : d > l && (d = a === b.hourElement ? d - l - r(!b.amPM) : i,
                                    f && B(void 0, 1, b.hourElement)),
                            ...
                            N(),
                            ke(),
                            b._input.value !== a && b._debouncedChange()
                        }
                        function N() {
                            if (void 0 !== b.hourElement && void 0 !== b.minuteElement) {
                                ...
                                void 0 !== b.amPM && (f = e,
                                m = b.amPM.textContent,
                                e = f % 12 + 12 * r(m === b.l10n.amPM[1]));
                                ...
                                if (void 0 !== b.config.maxTime && void 0 !== b.config.minTime && b.config.minTime > b.config.maxTime) {
                                    ...
                                    if (i) {
                                        ...
                                        (e = Math.min(e, d.getHours())) === d.getHours() && (t = Math.min(t, d.getMinutes())),
                                        t === d.getMinutes() && (n = Math.min(n, d.getSeconds()))
                                    }
                                    if (a) {
                                        var u = void 0 !== b.config.minTime ? b.config.minTime : b.config.minDate;
                                        (e = Math.max(e, u.getHours())) === u.getHours() && t < u.getMinutes() && (t = u.getMinutes()),
                                        t === u.getMinutes() && (n = Math.max(n, u.getSeconds()))
                                    }
                                }
                                Y(e, t, n)
                            }
                        ...
                        function Y(e, t, n) {
                            void 0 !== b.latestSelectedDateObj && b.latestSelectedDateObj.setHours(e % 24, t, n || 0, 0),
                            b.hourElement && b.minuteElement && !b.isMobile && (b.hourElement.value = o(b.config.time_24hr ? e : (12 + e) % 12 + 12 * r(e % 12 == 0)),
                            b.minuteElement.value = o(t),
                            void 0 !== b.amPM && (b.amPM.textContent = b.l10n.amPM[r(e >= 12)]),
                            void 0 !== b.secondElement && (b.secondElement.value = o(n)))
                        }
                        function j(e) {
                            var t = g(e)
                        ...
                        function R(e, t) {
                            var n = void 0 !== e ? b.parseDate(e) : b.latestSelectedDateObj || (b.config.minDate && b.config.minDate > b.now ? b.config.minDate : b.config.maxDate && b.config.maxDate < b.now ? b.config.maxDate : b.now)
                              ...
                              , i = b.currentMonth;
                            try {
                                void 0 !== n && (b.currentYear = n.getFullYear(),
                                b.currentMonth = n.getMonth())
                            } catch (e) {
                                e.message = "Invalid date supplied: " + n,
                                b.config.errorHandler(e)
                            }
                            t && b.currentYear !== a && (ye("onYearChange"),
                            z()),
                            !t || b.currentYear === a && b.currentMonth === i || ye("onMonthChange"),
                            b.redraw()
                        }
                        function W(e) {
                            var t = g(e);
                        ...
                        function J(e, t, n, a) {
                            ...
                            return o.dateObj = t,
                            o.$i = a,
                            o.setAttribute("aria-label", b.formatDate(t, b.config.ariaDateFormat)),
                            -1 === e.indexOf("hidden") && 0 === C(t, b.now) && (b.todayDateElem = o,
                            o.classList.add("today"),
                            o.setAttribute("aria-current", "date")),
                            i ? (o.tabIndex = -1,
                            Me(t) && (o.classList.add("selected"),
                            b.selectedDateElem = o,
                            "range" === b.config.mode && (s(o, "startRange", b.selectedDates[0] && 0 === C(t, b.selectedDates[0], !0)),
                            s(o, "endRange", b.selectedDates[1] && 0 === C(t, b.selectedDates[1], !0)),
                            "nextMonthDay" === e && o.classList.add("inRange")))) : o.classList.add("flatpickr-disabled"),
                            "range" === b.config.mode && function(e) {
                                return !("range" !== b.config.mode || b.selectedDates.length < 2) && C(e, b.selectedDates[0]) >= 0 && C(e, b.selectedDates[1]) <= 0
                            }(t) && !Me(t) && o.classList.add("inRange"),
                            b.weekNumbers && 1 === b.config.showMonths && "prevMonthDay" !== e && a % 7 == 6 && b.weekNumbers.insertAdjacentHTML("beforeend", "<span class='flatpickr-day'>" + b.config.getWeek(t) + "</span>"),
                            ye("onDayCreate", o),
                            o
                        }
                        function K(e) {
                            e.focus(),
                            "range" === b.config.mode && ce(e)
                        }
                        function U(e) {
                            for (var t = e > 0 ? 0 : b.config.showMonths - 1, n = e > 0 ? b.config.showMonths : -1, a = t; a != n; a += e)
                                for (var i = b.daysContainer.children[a], o = e > 0 ? 0 : i.children.length - 1, r = e > 0 ? i.children.length : -1, l = o; l != r; l += e) {
                                    var c = i.children[l];
                                    if (-1 === c.className.indexOf("hidden") && ie(c.dateObj))
                                        return c
                                }
                        }
                        function q(e, t) {
                            var n = I()
                              , a = oe(n || document.body)
                            ...
                            void 0 === i ? b._input.focus() : a ? function(e, t) {
                                for (var n = -1 === e.className.indexOf("Month") ? e.dateObj.getMonth() : b.currentMonth, a = t > 0 ? b.config.showMonths : -1, i = t > 0 ? 1 : -1, o = n - b.currentMonth; o != a; o += i)
                                    for (var r = b.daysContainer.children[o], l = n - b.currentMonth === o ? e.$i + t : t < 0 ? r.children.length - 1 : 0, c = r.children.length, s = l; s >= 0 && s < c && s != (t > 0 ? c : -1); s += i) {
                                        var d = r.children[s];
                                        if (-1 === d.className.indexOf("hidden") && ie(d.dateObj) && Math.abs(e.$i - s) >= Math.abs(t))
                                            return K(d)
                                    }
                                b.changeMonth(i),
                                q(U(i), 0)
                        ...
                        function $(e, t) {
                            for (var n = (new Date(e,t,1).getDay() - b.l10n.firstDayOfWeek + 7) % 7, a = b.utils.getDaysInMonth((t - 1 + 12) % 12, e), i = b.utils.getDaysInMonth(t, e), o = window.document.createDocumentFragment(), r = b.config.showMonths > 1, l = r ? "prevMonthDay hidden" : "prevMonthDay", c = r ? "nextMonthDay hidden" : "nextMonthDay", s = a + 1 - n, u = 0; s <= a; s++,
                            u++)
                                o.appendChild(J("flatpickr-day " + l, new Date(e,t - 1,s), 0, u));
                            for (s = 1; s <= i; s++,
                            u++)
                                o.appendChild(J("flatpickr-day", new Date(e,t,s), 0, u));
                            for (var f = i + 1; f <= 42 - n && (1 === b.config.showMonths || u % 7 != 0); f++,
                            u++)
                                o.appendChild(J("flatpickr-day " + c, new Date(e,t + 1,f % i), 0, u));
                        ...
                        function V() {
                            if (void 0 !== b.daysContainer) {
                                ...
                                for (var e = document.createDocumentFragment(), t = 0; t < b.config.showMonths; t++) {
                                    ...
                                    e.appendChild($(n.getFullYear(), n.getMonth()))
                                }
                                b.daysContainer.appendChild(e),
                                b.days = b.daysContainer.firstChild,
                                "range" === b.config.mode && 1 === b.selectedDates.length && ce()
                            }
                        }
                        function z() {
                            if (!(b.config.showMonths > 1 || "dropdown" !== b.config.monthSelectorType)) {
                                ...
                                for (var t = 0; t < 12; t++)
                                    if (e(t)) {
                                        ...
                                        n.value = new Date(b.currentYear,t).getMonth().toString(),
                                        n.textContent = h(t, b.config.shorthandCurrentMonth, b.l10n),
                                        n.tabIndex = -1,
                        ...
                        function G() {
                            ...
                            b.config.showMonths > 1 || "static" === b.config.monthSelectorType ? e = d("span", "cur-month") : (b.monthsDropdownContainer = d("select", "flatpickr-monthDropdown-months"),
                            b.monthsDropdownContainer.setAttribute("aria-label", b.l10n.monthAriaLabel),
                            H(b.monthsDropdownContainer, "change", (function(e) {
                                var t = g(e)
                                  , n = parseInt(t.value, 10);
                                b.changeMonth(n - b.currentMonth),
                                ye("onMonthChange")
                            }
                            )),
                            z(),
                            ...
                            b.config.maxDate && (i.setAttribute("max", b.config.maxDate.getFullYear().toString()),
                            i.disabled = !!b.config.minDate && b.config.minDate.getFullYear() === b.config.maxDate.getFullYear());
                        ...
                        function Z() {
                            ...
                            b.config.showMonths && (b.yearElements = [],
                            b.monthElements = []);
                        ...
                        function ee(e, t) {
                            ...
                            n < 0 && !0 === b._hidePrevMonthArrow || n > 0 && !0 === b._hideNextMonthArrow || (b.currentMonth += n,
                            (b.currentMonth < 0 || b.currentMonth > 11) && (b.currentYear += b.currentMonth > 11 ? 1 : -1,
                        ...
                        function ne(e) {
                            if (b.isOpen && !b.config.inline) {
                                ...
                                void 0 !== b.timeContainer && void 0 !== b.minuteElement && void 0 !== b.hourElement && "" !== b.input.value && void 0 !== b.input.value && A(),
                                b.close(),
                        ...
                        function ae(e) {
                            if (!(!e || b.config.minDate && e < b.config.minDate.getFullYear() || b.config.maxDate && e > b.config.maxDate.getFullYear())) {
                                ...
                                b.config.maxDate && b.currentYear === b.config.maxDate.getFullYear() ? b.currentMonth = Math.min(b.config.maxDate.getMonth(), b.currentMonth) : b.config.minDate && b.currentYear === b.config.minDate.getFullYear() && (b.currentMonth = Math.max(b.config.minDate.getMonth(), b.currentMonth)),
                                n && (b.redraw(),
                                ye("onYearChange"),
                                z())
                            }
                        ...
                        function ie(e, t) {
                            ...
                            if (b.config.minDate && a && C(a, b.config.minDate, void 0 !== t ? t : !b.minDateHasTime) < 0 || b.config.maxDate && a && C(a, b.config.maxDate, void 0 !== t ? t : !b.maxDateHasTime) > 0)
                                return !1;
                        ...
                        function le(e) {
                            ...
                            if (13 === e.keyCode && n) {
                                if (a)
                                    return b.setDate(b._input.value, !0, t === b.altInput ? b.config.altFormat : b.config.dateFormat),
                                    b.close(),
                                    t.blur();
                                b.open()
                            } else if (te(t) || i || o) {
                                ...
                                case 8:
                                case 46:
                                    n && !b.config.allowInput && (e.preventDefault(),
                                    b.clear());
                                    break;
                                case 37:
                                case 39:
                                    if (r || n)
                                        b.hourElement && b.hourElement.focus();
                                    else {
                                        e.preventDefault();
                                        var l = I();
                                ...
                                case 40:
                                    ...
                                    b.daysContainer && void 0 !== t.$i || t === b.input || t === b.altInput ? e.ctrlKey ? (e.stopPropagation(),
                                    ae(b.currentYear - s),
                                    q(U(1), 0)) : r || q(void 0, 7 * s) : t === b.currentYearElement ? ae(b.currentYear - s) : b.config.enableTime && (!r && b.hourElement && b.hourElement.focus(),
                                    A(e),
                                    b._debouncedChange());
                                    break;
                                case 9:
                                    if (r) {
                                        ...
                                        !b.config.noCalendar && b.daysContainer && b.daysContainer.contains(t) && e.shiftKey && (e.preventDefault(),
                                        b._input.focus())
                                }
                            }
                        ...
                        function ce(e, t) {
                            ...
                            1 === b.selectedDates.length && (!e || e.classList.contains(t) && !e.classList.contains("flatpickr-disabled"))) {
                                for (var n = e ? e.dateObj.getTime() : b.days.firstElementChild.dateObj.getTime(), a = b.parseDate(b.selectedDates[0], void 0, !0).getTime(), i = Math.min(n, b.selectedDates[0].getTime()), o = Math.max(n, b.selectedDates[0].getTime()), r = !1, l = 0, c = 0, s = i; s < o; s += k.DAY)
                                    ie(new Date(s), !0) || (r = r || s > i && s < o,
                                ...
                                Array.from(b.rContainer.querySelectorAll("*:nth-child(-n+" + b.config.showMonths + ") > ." + t)).forEach((function(t) {
                                    ...
                                    void 0 !== e && (e.classList.add(n <= b.selectedDates[0].getTime() ? "startRange" : "endRange"),
                                    a < n && i === a ? t.classList.add("startRange") : a > n && i === a && t.classList.add("endRange"),
                                    i >= l && (0 === c || i <= c) && M(i, a, n) && t.classList.add("inRange")))
                                }
                                ))
                            }
                        }
                        ...
                        function de(e) {
                            return function(t) {
                                ...
                                void 0 !== n && (b["min" === e ? "minDateHasTime" : "maxDateHasTime"] = n.getHours() > 0 || n.getMinutes() > 0 || n.getSeconds() > 0),
                                b.selectedDates && (b.selectedDates = b.selectedDates.filter((function(e) {
                                    return ie(e)
                                }
                                )),
                                b.selectedDates.length || "min" !== e || P(n),
                                ke()),
                                b.daysContainer && (ge(),
                                void 0 !== n ? b.currentYearElement[e] = n.getFullYear().toString() : b.currentYearElement.removeAttribute(e),
                                b.currentYearElement.disabled = !!a && void 0 !== n && a.getFullYear() === n.getFullYear())
                            }
                        }
                        function ue() {
                        ...
                        function fe() {
                            "object" != typeof b.config.locale && void 0 === O.l10ns[b.config.locale] && b.config.errorHandler(new Error("flatpickr: invalid locale " + b.config.locale)),
                            b.l10n = e(e({}, O.l10ns.default), "object" == typeof b.config.locale ? b.config.locale : "default" !== b.config.locale ? O.l10ns[b.config.locale] : void 0),
                            ...
                            void 0 === e(e({}, v), JSON.parse(JSON.stringify(p.dataset || {}))).time_24hr && void 0 === O.defaultConfig.time_24hr && (b.config.time_24hr = b.l10n.time_24hr),
                            b.formatDate = w(b),
                            b.parseDate = y({
                                config: b.config,
                                l10n: b.l10n
                        ...
                        function me(e) {
                            if ("function" != typeof b.config.position) {
                                if (void 0 !== b.calendarContainer) {
                                    ...
                                    if (s(b.calendarContainer, "arrowTop", !d),
                                    ...
                                    !b.config.inline) {
                                        ...
                                        if (s(b.calendarContainer, "rightMost", h),
                                        !b.config.static)
                                            if (b.calendarContainer.style.top = u + "px",
                                            h)
                                                if (v) {
                                                    var D = function() {
                                                    ...
                                                    D.insertRule(".flatpickr-calendar.centerMost:before,.flatpickr-calendar.centerMost:after" + M, C),
                                ...
                                b.config.position(b, e)
                        }
                        function ge() {
                            b.config.noCalendar || b.isMobile || (z(),
                            xe(),
                            V())
                        }
                        function pe() {
                            b._input.focus(),
                            -1 !== window.navigator.userAgent.indexOf("MSIE") || void 0 !== navigator.msMaxTouchPoints ? setTimeout(b.close, 0) : b.close()
                        }
                        function he(e) {
                            e.preventDefault(),
                            e.stopPropagation();
                            ...
                            if (void 0 !== t) {
                                ...
                                "single" === b.config.mode)
                                    ...
                                    "range" === b.config.mode && (2 === b.selectedDates.length && b.clear(!1, !1),
                                    b.latestSelectedDateObj = a,
                                    b.selectedDates.push(a),
                                    0 !== C(a, b.selectedDates[0], !0) && b.selectedDates.sort((function(e, t) {
                                ...
                                i) {
                                    ...
                                    b.currentYear = a.getFullYear(),
                                    b.currentMonth = a.getMonth(),
                                    r && (ye("onYearChange"),
                                    z()),
                                    ye("onMonthChange")
                                }
                                ...
                                V(),
                                ke(),
                                i || "range" === b.config.mode || 1 !== b.config.showMonths ? void 0 !== b.selectedDateElem && void 0 === b.hourElement && b.selectedDateElem && b.selectedDateElem.focus() : K(n),
                        ...
                        b.loadedPlugins = [],
                        b._bind = H,
                        b._setHoursFromDate = P,
                        b._positionCalendar = me,
                        b.changeMonth = ee,
                        b.changeYear = ae,
                        b.clear = function(e, t) {
                            if (void 0 === e && (e = !0),
                            void 0 === t && (t = !0),
                            b.input.value = "",
                            ...
                            !0 === t && (b.currentYear = b._initialDate.getFullYear(),
                        ...
                        b.close = function() {
                            b.isOpen = !1,
                            b.isMobile || (void 0 !== b.calendarContainer && b.calendarContainer.classList.remove("open"),
                        ...
                        b.destroy = function() {
                            ...
                            for (var e = b._handlers.length; e--; )
                                b._handlers[e].remove();
                            if (b._handlers = [],
                            b.mobileInput)
                                b.mobileInput.parentNode && b.mobileInput.parentNode.removeChild(b.mobileInput),
                                ...
                                if (b.config.static && b.calendarContainer.parentNode) {
                                    ...
                                    b.calendarContainer.parentNode.removeChild(b.calendarContainer);
                            b.altInput && (b.input.type = "text",
                            b.altInput.parentNode && b.altInput.parentNode.removeChild(b.altInput),
                            delete b.altInput),
                            b.input && (b.input.type = b.input._type,
                        ...
                        b.updateValue = ke,
                        b.open = function(e, t) {
                            if (void 0 === t && (t = b._positionElement),
                            !0 === b.isMobile) {
                                if (e) {
                                    e.preventDefault();
                                    var n = g(e);
                                ...
                                return void 0 !== b.mobileInput && (b.mobileInput.focus(),
                                b.mobileInput.click()),
                                void ye("onOpen")
                            }
                            if (!b._input.disabled && !b.config.inline) {
                                var a = b.isOpen;
                                b.isOpen = !0,
                                a || (b.calendarContainer.classList.add("open"),
                        ...
                        b.set = function(e, t) {
                            if (null !== e && "object" == typeof e)
                                for (var a in Object.assign(b.config, e),
                                e)
                                    void 0 !== ve[a] && ve[a].forEach((function(e) {
                                        return e()
                                    }
                                    ));
                            else
                                b.config[e] = t,
                                void 0 !== ve[e] ? ve[e].forEach((function(e) {
                                    return e()
                                }
                        ...
                        b.setDate = function(e, t, n) {
                            ...
                            0 !== e && !e || e instanceof Array && 0 === e.length)
                                return b.clear(t);
                            De(e, n),
                            b.latestSelectedDateObj = b.selectedDates[b.selectedDates.length - 1],
                            b.redraw(),
                            R(void 0, t),
                            P(),
                        ...
                        var ve = {
                            ...
                            positionElement: [we],
                            clickOpens: [function() {
                                !0 === b.config.clickOpens ? (H(b._input, "focus", b.open),
                                H(b._input, "click", b.open)) : (b._input.removeEventListener("focus", b.open),
                        ...
                        function De(e, t) {
                            ...
                            if (e instanceof Array)
                                ...
                                b.config.errorHandler(new Error("Invalid date supplied: " + JSON.stringify(e)));
                        ...
                        function ye(e, t) {
                            if (void 0 !== b.config) {
                                ...
                                "onChange" === e && (b.input.dispatchEvent(Ce("change")),
                                b.input.dispatchEvent(Ce("input")))
                            }
                        }
                        function Ce(e) {
                        ...
                        function xe() {
                            b.config.noCalendar || b.isMobile || !b.monthNav || (b.yearElements.forEach((function(e, t) {
                                var n = new Date(b.currentYear,b.currentMonth,1);
                                n.setMonth(b.currentMonth + t),
                                b.config.showMonths > 1 || "static" === b.config.monthSelectorType ? b.monthElements[t].textContent = h(n.getMonth(), b.config.shorthandCurrentMonth, b.l10n) + " " : b.monthsDropdownContainer.value = n.getMonth().toString(),
                            ...
                            b._hideNextMonthArrow = void 0 !== b.config.maxDate && (b.currentYear === b.config.maxDate.getFullYear() ? b.currentMonth + 1 > b.config.maxDate.getMonth() : b.currentYear > b.config.maxDate.getFullYear()))
                        }
                        function Ee(e) {
                        ...
                        function ke(e) {
                            ...
                            b.input.value = Ee(b.config.dateFormat),
                            void 0 !== b.altInput && (b.altInput.value = Ee(b.config.altFormat)),
                        ...
                        return function() {
                            ...
                            function() {
                                ...
                                "time" === i.mode && (b.config.noCalendar = !0,
                                b.config.enableTime = !0),
                                Object.assign(b.config, o, i);
                                for (var u = 0; u < t.length; u++)
                                    b.config[t[u]] = !0 === b.config[t[u]] || "true" === b.config[t[u]];
                                ...
                                u = 0; u < b.config.plugins.length; u++) {
                                    var f = b.config.plugins[u](b) || {};
                                    for (var m in f)
                                        n.indexOf(m) > -1 ? b.config[m] = c(f[m]).map(_).concat(b.config[m]) : void 0 === i[m] && (b.config[m] = f[m])
                                }
                                i.altInputClass || (b.config.altInputClass = ue().className + " " + b.config.altInputClass),
                                ye("onParseConfig")
                            }(),
                            fe(),
                            b.input = ue(),
                            b.input ? (b.input._type = b.input.type,
                            b.input.type = "text",
                            b.input.classList.add("flatpickr-input"),
                            b._input = b.input,
                            b.config.altInput && (b.altInput = d(b.input.nodeName, b.config.altInputClass),
                            b._input = b.altInput,
                            ...
                            we()) : b.config.errorHandler(new Error("Invalid input element specified")),
                            function() {
                                b.selectedDates = [],
                                ...
                                b._initialDate = b.selectedDates.length > 0 ? b.selectedDates[0] : b.config.minDate && b.config.minDate.getTime() > b.now.getTime() ? b.config.minDate : b.config.maxDate && b.config.maxDate.getTime() < b.now.getTime() ? b.config.maxDate : b.now,
                            ...
                            b.utils = {
                                getDaysInMonth: function(e, t) {
                                    return void 0 === e && (e = b.currentMonth),
                                    void 0 === t && (t = b.currentYear),
                                    1 === e && (t % 4 == 0 && t % 100 != 0 || t % 400 == 0) ? 29 : b.l10n.daysInMonth[e]
                                }
                            },
                            b.isMobile || function() {
                                var e = window.document.createDocumentFragment();
                                if (b.calendarContainer = d("div", "flatpickr-calendar"),
                                b.calendarContainer.tabIndex = -1,
                                !b.config.noCalendar) {
                                    if (e.appendChild((b.monthNav = d("div", "flatpickr-months"),
                                    b.yearElements = [],
                                    b.monthElements = [],
                                    ...
                                    Object.defineProperty(b, "_hidePrevMonthArrow", {
                                        ...
                                        set: function(e) {
                                            b.__hidePrevMonthArrow !== e && (s(b.prevMonthNav, "flatpickr-disabled", e),
                                    ...
                                    Object.defineProperty(b, "_hideNextMonthArrow", {
                                        ...
                                        set: function(e) {
                                            b.__hideNextMonthArrow !== e && (s(b.nextMonthNav, "flatpickr-disabled", e),
                                    ...
                                    b.rContainer.appendChild(Q()),
                                    b.daysContainer || (b.daysContainer = d("div", "flatpickr-days"),
                                ...
                                b.config.enableTime && e.appendChild(function() {
                                    ...
                                    b.config.noCalendar && b.calendarContainer.classList.add("noCalendar");
                                    var e = T(b.config);
                                    ...
                                    if (b.minuteElement = a.getElementsByTagName("input")[0],
                                    b.hourElement.tabIndex = b.minuteElement.tabIndex = -1,
                                    b.hourElement.value = o(b.latestSelectedDateObj ? b.latestSelectedDateObj.getHours() : b.config.time_24hr ? e.hours : function(e) {
                                        switch (e % 24) {
                                        case 0:
                                        case 12:
                                            return 12;
                                    ...
                                    return b.config.time_24hr || (b.amPM = d("span", "flatpickr-am-pm", b.l10n.amPM[r((b.latestSelectedDateObj ? b.hourElement.value : b.config.defaultHour) > 11)]),
                                ...
                                if ((b.config.inline || b.config.static) && (b.calendarContainer.classList.add(b.config.inline ? "inline" : "static"),
                                b.config.inline && (!i && b.element.parentNode ? b.element.parentNode.insertBefore(b.calendarContainer, b._input.nextSibling) : void 0 !== b.config.appendTo && b.config.appendTo.appendChild(b.calendarContainer)),
                                b.config.static)) {
                                    var l = d("div", "flatpickr-wrapper");
                                    b.element.parentNode && b.element.parentNode.insertBefore(l, b.element),
                                    l.appendChild(b.element),
                                    b.altInput && l.appendChild(b.altInput),
                                    l.appendChild(b.calendarContainer)
                                }
                            ...
                            function() {
                                ...
                                b.isMobile)
                                    ...
                                    var e = l(se, 50);
                                    if (b._debouncedChange = l(L, S),
                                    b.daysContainer && !/iPhone|iPad|iPod/i.test(navigator.userAgent) && H(b.daysContainer, "mouseover", (function(e) {
                                        "range" === b.config.mode && ce(g(e))
                                    }
                                    )),
                                    H(b._input, "keydown", le),
                                    void 0 !== b.calendarContainer && H(b.calendarContainer, "keydown", le),
                                    b.config.inline || b.config.static || H(window, "resize", e),
                                    void 0 !== window.ontouchstart ? H(window.document, "touchstart", ne) : H(window.document, "mousedown", ne),
                                    H(window.document, "focus", ne, {
                                        capture: !0
                                    }),
                                    !0 === b.config.clickOpens && (H(b._input, "focus", b.open),
                                    H(b._input, "click", b.open)),
                                    void 0 !== b.daysContainer && (H(b.monthNav, "click", Te),
                                    H(b.monthNav, ["keyup", "increment"], j),
                                    H(b.daysContainer, "click", he)),
                                    void 0 !== b.timeContainer && void 0 !== b.minuteElement && void 0 !== b.hourElement) {
                                        var t = function(e) {
                                            return g(e).select()
                                        };
                                        H(b.timeContainer, ["increment"], A),
                                        H(b.timeContainer, "blur", A, {
                                            capture: !0
                                        }),
                                        H(b.timeContainer, "click", W),
                                        H([b.hourElement, b.minuteElement], ["focus", "click"], t),
                                        void 0 !== b.secondElement && H(b.secondElement, "focus", (function() {
                            ...
                            (b.selectedDates.length || b.config.noCalendar) && (b.config.enableTime && P(b.config.noCalendar ? b.latestSelectedDateObj : void 0),
                            ke(!1)),
                            F();
