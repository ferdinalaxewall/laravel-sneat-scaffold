                ...
                t.exports = function() {
                    ...
                    var O = {
                            ...
                            !(r && !o && !n.templates.dropdownItemNoMatch || !1 === n.dropdown.enable || this.state.isLoading || this.settings.readonly)) {
                                ...
                                !a) {
                                    if (this.suggestedListItems.length)
                                        t && o && !this.state.editing.scope && !s(this.suggestedListItems[0].value, t) && this.suggestedListItems.unshift({
                                            value: t
                                        });
                                    else {
                        ...
                        position(t) {
                            ...
                            if ("manual" != e.position) {
                                var i, s, a, n, o, r, l, d, h, g = this.DOM.dropdown, p = e.RTL, c = e.appendTarget === document.body, u = c ? window.pageYOffset : e.appendTarget.scrollTop, m = document.fullscreenElement || document.webkitFullscreenElement || document.documentElement, v = m.clientHeight, f = Math.max(m.clientWidth || 0, window.innerWidth || 0) > 480 ? e.position : "all", T = this.DOM["input" == f ? "input" : "scope"];
                                ...
                                this.state.dropdown.visible) {
                                    ...
                                    s = (i = T.getBoundingClientRect()).top - r.top,
                                    a = i.bottom - 1 - r.top,
                                    n = i.left - r.left,
                                    o = i.width + "px"),
                                    !c) {
                                    ...
                                    s = Math.floor(s),
                                    a = Math.ceil(a),
                                    d = ((l = e.placeAbove ?? v - i.bottom < t) ? s : a) + u,
                                    h = `left: ${n + (p && i.width || 0) + window.pageXOffset}px;`,
                                    g.style.cssText = `${h}; top: ${d}px; min-width: ${o}; max-width: ${o}`,
                                    g.setAttribute("placement", l ? "top" : "bottom"),
                                    ...
                                    if (this.state.hasFocus && !this.state.composing) {
                                        ...
                                        e.hooks.beforeKeyDown(t, {
                                            ...
                                            case "Up":
                                                ...
                                                i && (i = this.dropdown.getNextOrPrevOption(i, !r)),
                                                i && i.matches(e.classNames.dropdownItemSelector) || (i = o[r ? o.length - 1 : 0]),
                                                this.dropdown.highlightOption(i, !0);
                                                break;
                                            case "Escape":
                                            case "Esc":
                                                this.dropdown.hide();
                                            ...
                                            case "Tab":
                                                {
                                                    ...
                                                    if (!a && i && n && !this.state.editing) {
                                                        ...
                                                        return this.input.autocomplete.set.call(this, l),
                                                        !1
                                                    }
                                                    return !0
                                                }
                                            case "Enter":
                                                t.preventDefault(),
                                                e.hooks.suggestionClick(t, {
                                                    tagify: this,
                                                    tagData: s,
                                                    suggestionElm: i
                                                }).then((()=>{
                                                    if (i)
                                                        return this.dropdown.selectOption(i),
                                                        i = this.dropdown.getNextOrPrevOption(i, !r),
                                                        void this.dropdown.highlightOption(i);
                                                    this.dropdown.hide(),
                                                    a || this.addTags(this.state.inputText.trim(), !0)
                                                }
                                                )).catch((t=>t));
                                                break;
                                            case "Backspace":
                                                {
                                                    if (a || this.state.editing.scope)
                                                        return;
                        ...
                        selectOption(t, e) {
                            ...
                            o && (l || r)) {
                                if (this.state.editing) {
                                    ...
                                    this["mix" == i.mode ? "addMixTags" : "addTags"]([l || this.input.raw.call(this)], a);
                        ...
                        filterListItems(t, e) {
                            ...
                            if (!(t = "select" == r.mode && this.value.length && this.value[0][r.tagTextProp] == t ? "" : t) || !m.length)
                                return d = l.includeSelectedTags ? p : p.filter((t=>!this.isTagDuplicate(h(t) ? t.value : t))),
                            ...
                            for (o = l.caseSensitive ? "" + t : ("" + t).toLowerCase(); v < p.length; v++) {
                                ...
                                let u = Object.keys(i).some((t=>m.includes(t))) ? m : ["value"];
                                l.fuzzySearch && !e.exact ? (a = u.reduce(((t,e)=>t + " " + (i[e] || "")), "").toLowerCase().trim(),
                                l.accentedSearch && (a = c(a),
                                o = c(o)),
                                t = 0 == a.indexOf(o),
                                r = a === o,
                                s = f(a, o)) : (t = !0,
                                ...
                                n = !l.includeSelectedTags && this.isTagDuplicate(h(i) ? i.value : i),
                                s && !n && (r && t ? g.push(i) : "startsWith" == l.sortby && t ? d.unshift(i) : d.push(i))
                            }
                            return this.state.dropdown.suggestions = g.concat(d),
                            "function" == typeof l.sortby ? l.sortby(g.concat(d), o) : g.concat(d).slice(0, u)
                        },
                        getMappedValue(t) {
                        ...
                        createListHTML(t) {
                            return g([], t).map(((t,i)=>{
                                ...
                                return s = "string" == typeof s && this.settings.dropdown.escapeHTML ? d(s) : s,
                    ...
                    var M, I = {
                        ...
                        callbacks: {
                            onFocusBlur(t) {
                                ...
                                if (!r && !l)
                                    ...
                                    "mix" != e.mode) {
                                        ...
                                        i = ""),
                                        s === i && (i = "")),
                                        i && !this.state.actions.selectOption && e.addTagOnBlur && e.addTagOn.includes("blur") && this.addTags(i, !0)),
                            ...
                            onWindowKeyDown(t) {
                                var e, i = document.activeElement, s = v.call(this, i) && this.DOM.scope.contains(document.activeElement), a = s && i.hasAttribute("readonly");
                                if (s && !a)
                                    ...
                                    e.hooks.beforeKeyDown(t, {
                                        ...
                                        if ("mix" == e.mode) {
                                            ...
                                            case "Backspace":
                                                ...
                                                var h, g, p, c = this.getTagElms(), m = 1 === a.anchorNode.length && a.anchorNode.nodeValue == String.fromCharCode(8203);
                                                if ("edit" == e.backspace && d)
                                                    return h = 1 == a.anchorNode.nodeType ? null : a.anchorNode.previousElementSibling,
                                                    setTimeout(this.editTag.bind(this), 0, h),
                                                    void t.preventDefault();
                                                if (u() && d instanceof Element)
                                                    return p = l(d),
                                                ...
                                                if ("BR" == a.anchorNode.nodeName)
                                                    return;
                                                if ((n || d) && 1 == a.anchorNode.nodeType ? g = 0 == a.anchorOffset ? n ? c[0] : null : c[Math.min(c.length, a.anchorOffset) - 1] : n ? g = a.anchorNode.nextElementSibling : d instanceof Element && (g = d),
                                                3 == a.anchorNode.nodeType && !a.anchorNode.nodeValue && a.anchorNode.previousElementSibling && t.preventDefault(),
                                                (d || n) && !e.backspace)
                                                    return void t.preventDefault();
                                                if ("Range" != a.type && !a.anchorOffset && a.anchorNode == this.DOM.input && "Delete" != t.key)
                                                    return void t.preventDefault();
                                                if ("Range" != a.type && g && g.hasAttribute("readonly"))
                                                    return void w(l(g));
                                                "Delete" == t.key && m && T(a.anchorNode.nextSibling) && this.removeTags(a.anchorNode.nextSibling),
                                                clearTimeout(M),
                                                M = setTimeout((()=>{
                                                    var t = document.getSelection();
                                                    o(this.DOM.input.innerHTML),
                                                    !n && t.anchorNode.previousSibling,
                                        ...
                                        case "Enter":
                                            if (this.state.dropdown.visible && !v)
                                                return;
                                            t.preventDefault(),
                                            setTimeout((()=>{
                            ...
                            onMixTagsInput(t) {
                                var e, i, s, a, n, o, r, l, d = this.settings, h = this.value.length, p = this.getTagElms(), c = document.createDocumentFragment(), m = window.getSelection().getRangeAt(0), v = [].map.call(p, (t=>T(t).value));
                                ...
                                c.childNodes.length && (m.insertNode(c),
                                this.setRangeAtStartEnd(!1, c.lastChild)),
                                p.length != h)
                                    return this.value = [].map.call(this.getTagElms(), (t=>T(t))),
                                    void this.update({
                                ...
                                if (window.getSelection && (o = window.getSelection()).rangeCount > 0 && 3 == o.anchorNode.nodeType) {
                                    ...
                                    s = (e = m.toString().slice(0, m.endOffset)).split(d.pattern).length - 1,
                            ...
                            onEditTagBlur(t) {
                                if (this.state.editing && (this.state.hasFocus || this.toggleFocusClass(),
                                this.DOM.scope.contains(t))) {
                                    var e, i, s = this.settings, a = t.closest("." + s.classNames.tag), n = T(a), o = this.input.normalize.call(this, t), r = {
                                        [s.tagTextProp]: o,
                                        __tagId: n.__tagId
                                    }, l = n.__originalData, d = this.editTagChangeDetected(g(n, r)), h = this.validateTag(r);
                                    if (o)
                                        if (d) {
                            ...
                            onDoubleClickScope(t) {
                                var e, i, s = t.target.closest("." + this.settings.classNames.tag), a = T(s), n = this.settings;
                                    ...
                                    t.addedNodes.forEach((t=>{
                                        if ("<div><br></div>" == t.outerHTML)
                                            ...
                                            t.previousSibling && "BR" == t.previousSibling.nodeName) {
                                                ...
                                                t.previousSibling && !T(t.previousSibling) || t.before("​")
                                    }
                                    )),
                                    t.removedNodes.forEach((t=>{
                                        t && "BR" == t.nodeName && v.call(this, e) && (this.removeTags(e),
                    ...
                    function S(t, e) {
                                    ...
                                    i)
                                        if (t.settings.isJQueryPlugin)
                                            ...
                                            try {
                                                ...
                                                if ((o = a.cloneData ? g({}, o) : o).tagify = this,
                        ...
                        t=>{
                            let e, s = "/" + t;
                            if (1 == localStorage.getItem(D + i + "/v", 1))
                                try {
                        ...
                        this.setPersistedData = (t=>t ? (localStorage.setItem(D + t + "/v", 1),
                        (e,i)=>{
                            let s = "/" + i
                              , a = JSON.stringify(e);
                            e && i && (localStorage.setItem(D + t + s, a),
                    ...
                    return S.prototype = {
                        ...
                        applySettings(t, i) {
                            ...
                            a.placeholder = d(t.getAttribute("placeholder") || a.placeholder || ""),
                            ...
                            "autoComplete"in i && !h(i.autoComplete) && (a.autoComplete = y.autoComplete,
                        ...
                        editTag(t, e) {
                            ...
                            if (s) {
                                if (!(n instanceof Object && "editable"in n) || n.editable)
                                    ...
                                    s.addEventListener("blur", o.onEditTagBlur.bind(this, this.getTagTextNode(t))),
                                    ...
                                    e.skipValidation || (r = this.editTagToggleValidity(t)),
                                    s.originalIsValid = r,
                        ...
                        onEditTagDone(t, e) {
                            ...
                            t && ((i = e[a.tagTextProp]) ? i.trim() && i : a.tagTextProp in e ? void 0 : e.value) ? (t = this.replaceTag(t, e),
                            this.editTagToggleValidity(t, e),
                            a.a11y.focusableTags ? t.focus() : w(t)) : t && this.removeTags(t),
                        ...
                        injectAtCaret(t, e) {
                            if (!(e = e || this.state.selection?.range) && t)
                                return this.appendMixTags(t),
                                this;
                            let i = f(t, e);
                            return this.setRangeAtStartEnd(!1, i),
                            this.updateValueByDOMTags(),
                            this.update(),
                            this
                        },
                        input: {
                            ...
                            normalize(t, e) {
                                var i = t || this.DOM.input
                                  , s = [];
                                i.childNodes.forEach((t=>3 == t.nodeType && s.push(t.nodeValue))),
                                s = s.join("\n");
                                try {
                                ...
                                o.childNodes.forEach((o=>{
                                    if (1 == o.nodeType) {
                                        ...
                                        r && v.call(e, o)) {
                                            ...
                                            o.getAttribute("style") || ["B", "I", "U"].includes(o.tagName) ? t += o.textContent : "DIV" != o.tagName && "P" != o.tagName || (t += "\r\n",
                                            i(o))
                                    } else
                                        t += o.textContent
                                }
